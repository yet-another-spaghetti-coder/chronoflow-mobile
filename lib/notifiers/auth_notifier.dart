...
class AuthNotifier extends StateNotifier<AuthState>{
  ...
  Future<void> checkLoginStatus() async => state =AuthState(isLoggedIn: await _firebaseService.isLoggedIn());
  Future<void> signIn() async=> state = await _firebaseService.signInWithGoogle();
